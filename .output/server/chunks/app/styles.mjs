...
const styles = {
  ...
  "pages/homelast.vue": () => import('./_nuxt/homelast-styles.bb018f9c.mjs').then(interopDefault),
  ...
  "pages/p2p.vue": () => import('./_nuxt/p2p-styles.b4a70488.mjs').then(interopDefault),
