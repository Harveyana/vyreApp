...
const styles = {
  ...
  "components/assetpage.vue": () => import('./_nuxt/assetpage-styles.a555cb37.mjs').then(interopDefault),
  "components/order.vue": () => import('./_nuxt/order-styles.66c715ab.mjs').then(interopDefault),
  "components/transaction.vue": () => import('./_nuxt/transaction-styles.3ba19db9.mjs').then(interopDefault)
};
