...
const styles = {
  ...
  "pages/homelast.vue": () => import('./_nuxt/homelast-styles.737fd77a.mjs').then(interopDefault),
  ...
  "pages/p2p.vue": () => import('./_nuxt/p2p-styles.5f42281d.mjs').then(interopDefault),
