      ...
      _push(ssrRenderComponent(_component_ion_modal, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_ion_content, { class: "ion-padding tooba" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            return [
              ...
              createVNode(_component_ion_content, { class: "ion-padding tooba" }, {
                default: withCtx(() => [
                  unref(switchAssets) == "crypto" ? (openBlock(), createBlock(Fragment, { key: 0 }, renderList(cryptos, (crypto, index) => {
                    return createVNode(_component_ion_list, {
                      key: index,
...
const __nuxt_component_19 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e53213d8"]]);

export { __nuxt_component_19 as _ };
//# sourceMappingURL=allAssets-373dd25c.mjs.map
