import { _ as _export_sfc, l as IonCard, o as IonCardTitle, n as IonCardSubtitle, f as IonIcon, D as IonModal, i as IonHeader, I as IonToolbar, s as IonSegment, t as IonSegmentButton, g as IonLabel, j as IonButtons, k as IonButton, C as IonContent, u as IonList } from '../server.mjs';
import { a as arrowUpCircleSharp, i as returnUpBack } from './index-f41f3193.mjs';
import { useSSRContext, defineComponent, mergeProps, withCtx, createTextVNode, toDisplayString, unref, createVNode, ref, openBlock, createBlock, Fragment, renderList } from 'vue';
      ...
      _push(ssrRenderComponent(_component_ion_modal, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_ion_content, { class: "ion-padding content" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            return [
              ...
              createVNode(_component_ion_content, { class: "ion-padding content" }, {
                default: withCtx(() => [
                  unref(switchAssets) == "crypto" ? (openBlock(), createBlock(Fragment, { key: 0 }, renderList(cryptos, (crypto, index) => {
                    return createVNode(_component_ion_list, {
                      key: index,
...
const __nuxt_component_19 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6543823a"]]);

export { __nuxt_component_19 as _ };
//# sourceMappingURL=allAssets-08639481.mjs.map
