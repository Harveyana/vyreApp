import { _ as _export_sfc, h as IonPage, i as IonHeader, I as IonToolbar, j as IonButtons, k as IonButton, f as IonIcon, l as IonCard, m as IonCardHeader, n as IonCardSubtitle, o as IonCardTitle, p as IonCol, q as IonGrid, r as IonRow, s as IonSegment, t as IonSegmentButton, g as IonLabel, u as IonList, a as IonTabs, b as IonRouterOutlet, d as IonTabBar, e as IonTabButton } from '../server.mjs';
import { m as moon, e as eyeOffSharp, a as arrowUpCircleSharp, b as arrowDownCircleSharp, w as walletSharp, l as logoBitcoin, c as logoUsd, d as duplicate, _ as __nuxt_component_17, f as _sfc_main$2, p as playCircle, r as radio, g as library, s as search } from './addAsset-c6709841.mjs';
                  ...
                  _push3(ssrRenderComponent(_component_ion_card_header, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "justify-content": "space-between", "align-items": "center", "width": "100%" })}" data-v-2380c391${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_ion_card_title, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<strong style="${ssrRenderStyle({ "font-size": "150%" })}" data-v-2380c391${_scopeId4}>${ssrInterpolate(unref(hideTotal) ? "***********" : "$2,260,351.77")}</strong>`);
                            } else {
                              return [
                  ...
                  _push3(ssrRenderComponent(_component_ion_col, { class: "Actions" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<span style="${ssrRenderStyle({ "font-size": "x-small", "color": "white" })}" data-v-2380c391${_scopeId3}>Send</span>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_ion_col, { class: "Actions" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<span style="${ssrRenderStyle({ "font-size": "x-small", "color": "white" })}" data-v-2380c391${_scopeId3}>Recieve</span>`);
                      } else {
                        return [
                          createVNode(_component_ion_button, { size: "large" }, {
                            default: withCtx(() => [
                  ...
                  _push3(ssrRenderComponent(_component_ion_col, { class: "Actions" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<span style="${ssrRenderStyle({ "font-size": "x-small", "color": "white" })}" data-v-2380c391${_scopeId3}>Buy</span>`);
                      } else {
                        return [
                          createVNode(_component_ion_button, { size: "large" }, {
                            default: withCtx(() => [
...
const homeNot = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2380c391"]]);

export { homeNot as default };
//# sourceMappingURL=home-not-f4753ca5.mjs.map
