import { _ as _export_sfc, D as useIonRouter, m as IonButton, w as IonPage, g as IonHeader, h as IonToolbar, l as IonButtons, v as IonIcon, n as IonContent, I as IonCard, o as IonCardHeader, e as IonCardTitle, p as IonCardContent } from '../server.mjs';
import { useSwiper, Swiper, SwiperSlide } from 'swiper/vue';
import { useSSRContext, defineComponent, mergeProps, unref, withCtx, createTextVNode, createVNode, toDisplayString, ref, watch, openBlock, createBlock, Fragment, renderList } from 'vue';
...
import { m as moon } from './index-2d204393.mjs';
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(ssrRenderComponent(_component_ion_card, { style: { "box-shadow": "none", "padding-top": "25px", "padding-bottom": "25px", "margin-top": "20%" } }, {
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<img alt="Silhouette of mountains"${ssrRenderAttr("src", slide.img)} data-v-e3261b54${_scopeId5}>`);
...
const intro = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e3261b54"]]);

export { intro as default };
//# sourceMappingURL=intro-9e2e5afb.mjs.map
