import { _ as _export_sfc, D as useIonRouter, k as IonButton, h as IonPage, z as IonContent, l as IonCard, m as IonCardHeader, o as IonCardTitle, y as IonCardContent } from '../server.mjs';
                              ...
                              if (_push5) {
                                _push5(ssrRenderComponent(_component_ion_card, { style: { "box-shadow": "none", "padding-top": "25px", "padding-bottom": "25px", "margin-top": "20%", "background": "#E5E5E5", "min-height": "100%" } }, {
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<img alt="Silhouette of mountains"${ssrRenderAttr("src", slide.img)} data-v-4c01d655${_scopeId5}>`);
...
const intro = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4c01d655"]]);

export { intro as default };
//# sourceMappingURL=intro-f57be265.mjs.map
