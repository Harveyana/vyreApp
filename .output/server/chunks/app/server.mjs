...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/home-092d2a92.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-32e994c1.mjs').then((m) => m.default || m)
  },
  {
    name: "intro",
    path: "/intro",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/intro-e883e7dc.mjs').then((m) => m.default || m)
  }
];
...
const iosTransitionAnimation = () => import('./_nuxt/ios.transition-c805c2a3.mjs');
const mdTransitionAnimation = () => import('./_nuxt/md.transition-3754e033.mjs');
...
const Nav = /* @__PURE__ */ proxyCustomElement$1(class Nav2 extends H$1 {
  ...
  async componentDidLoad() {
    this.rootChanged();
    this.gesture = (await import('./_nuxt/swipe-back-1e473c75.mjs')).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
...
const Toggle = /* @__PURE__ */ proxyCustomElement$1(class Toggle2 extends H$1 {
  constructor() {
    ...
    this.setupGesture = async () => {
      ...
      if (toggleTrack) {
        this.gesture = (await import('./_nuxt/index2-cf5f2b6f.mjs')).createGesture({
          el: toggleTrack,
          gestureName: "toggle",
          gesturePriority: 100,
          threshold: 5,
...
const RouterOutlet = /* @__PURE__ */ proxyCustomElement$1(class RouterOutlet2 extends H$1 {
  ...
  async connectedCallback() {
    ...
    this.gesture = (await import('./_nuxt/swipe-back-1e473c75.mjs')).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
      var _a;
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!config.getBoolean("_testing")) {
          import('./_nuxt/index9-619901a5.mjs').then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid2)) {
          import('./_nuxt/status-tap-24afbdbb.mjs').then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import('./_nuxt/input-shims-11e860ed.mjs').then((module) => module.startInputShims(config, platform));
        }
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-d23d7532.mjs').then((r) => r.default || r));
...
export { isRTL$1 as A, clamp as B, getIonPageElement as C, raf as D, now as E, pointerCoord as F, readTask as G, findClosestIonContent as H, IonCard as I, componentOnReady as J, writeTask$1 as K, scrollToTop as L, Keyboard as M, addEventListener as N, removeEventListener as O, KeyboardResize as P, useRouter as Q, navigateTo as R, useHead as S, _export_sfc as _, IonCol as a, IonAvatar as b, createError as c, IonCardTitle as d, entry$1 as default, IonToolbar as e, IonTabs as f, IonRouterOutlet as g, IonTabBar as h, IonTabButton as i, IonIcon as j, IonLabel as k, IonPage as l, IonHeader as m, IonButtons as n, IonButton as o, IonCardHeader as p, IonCardSubtitle as q, IonGrid as r, IonRow as s, IonList as t, IonTitle as u, IonCardContent as v, IonToggle as w, IonFooter as x, useIonRouter as y, IonContent as z };
