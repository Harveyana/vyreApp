...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/homelast-13164a0b.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/newhome-db6104e7.mjs').then((m) => m.default || m)
  },
  {
    name: "p2p",
    path: "/p2p",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/p2p-cafef347.mjs').then((m) => m.default || m)
  }
];
