...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/home-8dbb0018.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-45e690e8.mjs').then((m) => m.default || m)
  },
  {
    name: "intro",
    path: "/intro",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/intro-e85fd65a.mjs').then((m) => m.default || m)
  }
];
...
const iosTransitionAnimation = () => import('./_nuxt/ios.transition-212860e1.mjs');
const mdTransitionAnimation = () => import('./_nuxt/md.transition-5ab9762a.mjs');
...
const Nav = /* @__PURE__ */ proxyCustomElement$1(class Nav2 extends H$1 {
  ...
  async componentDidLoad() {
    this.rootChanged();
    this.gesture = (await import('./_nuxt/swipe-back-08a21c8b.mjs')).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
...
const RouterOutlet = /* @__PURE__ */ proxyCustomElement$1(class RouterOutlet2 extends H$1 {
  ...
  async connectedCallback() {
    ...
    this.gesture = (await import('./_nuxt/swipe-back-08a21c8b.mjs')).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
      var _a;
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!config.getBoolean("_testing")) {
          import('./_nuxt/index9-bd0e2137.mjs').then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid2)) {
          import('./_nuxt/status-tap-13db3026.mjs').then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import('./_nuxt/input-shims-d19a9677.mjs').then((module) => module.startInputShims(config, platform));
        }
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-25a7aa77.mjs').then((r) => r.default || r));
...
export { IonToggle as A, IonFooter as B, useIonRouter as C, isRTL$1 as D, createGesture as E, clamp as F, createAnimation as G, getIonPageElement as H, IonCard as I, now$1 as J, pointerCoord as K, readTask as L, findClosestIonContent as M, componentOnReady as N, writeTask$1 as O, scrollToTop as P, Keyboard as Q, addEventListener$1 as R, removeEventListener as S, KeyboardResize as T, raf as U, useRouter as V, navigateTo as W, useHead as X, _export_sfc as _, IonCol as a, IonAvatar as b, createError as c, IonCardTitle as d, entry$1 as default, IonModal as e, IonHeader as f, IonToolbar as g, IonSegment as h, IonSegmentButton as i, IonLabel as j, IonButtons as k, IonButton as l, IonContent as m, IonCardHeader as n, IonCardContent as o, IonList as p, IonTabs as q, IonRouterOutlet as r, IonTabBar as s, IonTabButton as t, IonIcon as u, IonPage as v, IonCardSubtitle as w, IonGrid as x, IonRow as y, IonTitle as z };
