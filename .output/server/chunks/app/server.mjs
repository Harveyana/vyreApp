...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/homelast-7af1bca3.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/newhome-37c45e22.mjs').then((m) => m.default || m)
  },
  {
    name: "p2p",
    path: "/p2p",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/p2p-05c0173e.mjs').then((m) => m.default || m)
  }
];
