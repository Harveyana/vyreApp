...
export default {
  ...
  "pages/homelast.vue": () => import('./_nuxt/homelast-styles.985a2add.mjs').then(interopDefault),
  ...
  "pages/p2p.vue": () => import('./_nuxt/p2p-styles.745f38d0.mjs').then(interopDefault),
