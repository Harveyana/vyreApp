...
export default {
  ...
  "pages/homelast.vue": () => import('./_nuxt/homelast-styles.1c12c026.mjs').then(interopDefault),
  ...
  "pages/p2p.vue": () => import('./_nuxt/p2p-styles.0d162dc6.mjs').then(interopDefault),
