...
export default {
  ...
  "pages/newhome.vue": () => import('./_nuxt/newhome-styles.259a6049.mjs').then(interopDefault),
  ...
  "components/tabs.vue": () => import('./_nuxt/tabs-styles.207f87d7.mjs').then(interopDefault),
  "components/mainAsset.vue": () => import('./_nuxt/mainAsset-styles.6ef4db05.mjs').then(interopDefault)
}