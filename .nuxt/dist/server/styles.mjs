...
export default {
  "pages/home.vue": () => import('./_nuxt/home-styles.cad5375c.mjs').then(interopDefault),
  ...
  "components/asset.vue": () => import('./_nuxt/asset-styles.3abddd62.mjs').then(interopDefault)
}