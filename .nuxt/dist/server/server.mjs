...
const iosTransitionAnimation = () => import("./_nuxt/ios.transition-d5fd8f37.js");
const mdTransitionAnimation = () => import("./_nuxt/md.transition-4fb9d347.js");
...
const Nav = /* @__PURE__ */ proxyCustomElement$1(class Nav2 extends H$1 {
  ...
  async componentDidLoad() {
    this.rootChanged();
    this.gesture = (await import("./_nuxt/swipe-back-6b80783d.js")).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
...
const RouterOutlet = /* @__PURE__ */ proxyCustomElement$1(class RouterOutlet2 extends H$1 {
  ...
  async connectedCallback() {
    ...
    this.gesture = (await import("./_nuxt/swipe-back-6b80783d.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
      var _a;
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!config.getBoolean("_testing")) {
          import("./_nuxt/index9-a49f3070.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid2)) {
          import("./_nuxt/status-tap-26dd13a9.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./_nuxt/input-shims-a697f401.js").then((module) => module.startInputShims(config, platform));
        }
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-dbb219e4.js").then((r) => r.default || r));
...
export {
  ...
  pointerCoord as L,
  readTask as M,
  findClosestIonContent as N,
  componentOnReady as O,
  writeTask$1 as P,
  scrollToTop as Q,
  Keyboard as R,
  addEventListener$1 as S,
  removeEventListener as T,
  KeyboardResize as U,
  raf as V,
  useRouter as W,
  navigateTo as X,
  ...
  IonList as q,
  IonTabs as r,
  IonRouterOutlet as s,
  IonTabBar as t,
  IonTabButton as u,
  IonIcon as v,
  IonPage as w,
  IonCardSubtitle as x,
  IonGrid as y,
  IonRow as z
};
