                              ...
                              _push5(ssrRenderComponent(_component_ion_card_header, { style: {} }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    ...
                                    _push6(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "justify-content": "space-between", "align-items": "center", "width": "100%" })}" data-v-dd87532d${_scopeId5}>`);
                                    _push6(ssrRenderComponent(_component_ion_card_title, { color: "primary" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<strong style="${ssrRenderStyle({ "font-size": "80%" })}" data-v-dd87532d${_scopeId6}>${ssrInterpolate(unref(hideTotal) ? "***********" : "$2,260,351.77")}</strong>`);
                                        } else {
                                          return [
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(_component_ion_card_header, { style: {} }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "justify-content": "space-between", "align-items": "center", "width": "100%" })}" data-v-dd87532d${_scopeId6}>`);
                                          _push7(ssrRenderComponent(_component_ion_card_title, { color: "primary" }, {
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(`<strong style="${ssrRenderStyle({ "font-size": "50%" })}" data-v-dd87532d${_scopeId7}>${ssrInterpolate(unref(hideTotal) ? "***********" : "$2,260")}</strong>`);
                                              } else {
                                                return [
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          ...
                                          _push7(ssrRenderComponent(_component_ion_card_title, { color: "primary" }, {
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(`<strong style="${ssrRenderStyle({ "font-size": "50%" })}" data-v-dd87532d${_scopeId7}>${ssrInterpolate(unref(hideTotal) ? "***********" : "$1,260,351")}</strong>`);
                                              } else {
                                                return [
...
const p2p_vue_vue_type_style_index_0_scoped_dd87532d_lang = "";
...
const p2p = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-dd87532d"]]);
export {
  p2p as default
};
//# sourceMappingURL=p2p-cafef347.js.map
