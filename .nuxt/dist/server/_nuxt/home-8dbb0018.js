import { I as IonCard, a as IonCol, b as IonAvatar, d as IonCardTitle, _ as _export_sfc, e as IonModal, f as IonHeader, g as IonToolbar, h as IonSegment, i as IonSegmentButton, j as IonLabel, k as IonButtons, l as IonButton, m as IonContent, n as IonCardHeader, o as IonCardContent, p as IonList, q as IonTabs, r as IonRouterOutlet, s as IonTabBar, t as IonTabButton, u as IonIcon, v as IonPage, w as IonCardSubtitle, x as IonGrid, y as IonRow } from "../server.mjs";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_ion_card, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "justify-content": "start", "align-items": "center" })}" data-v-7138e59a${_scopeId}>`);
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_ion_avatar, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img alt="asset img"${ssrRenderAttr("src", _ctx.$props.img)} style="${ssrRenderStyle({ "scale": "0.55" })}" data-v-7138e59a${_scopeId3}>`);
                      } else {
                        return [
                          createVNode("img", {
                            alt: "asset img",
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_ion_card_title, { style: { "margin-bottom": "9px" } }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<strong data-v-7138e59a${_scopeId3}>${ssrInterpolate(_ctx.$props.symbol)}</strong>`);
                      } else {
                        return [
                  ...
                  _push3(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "justify-content": "start", "align-items": "center" })}" data-v-7138e59a${_scopeId2}><span style="${ssrRenderStyle({ "font-size": "small", "margin-right": "5px" })}" data-v-7138e59a${_scopeId2}>$${ssrInterpolate(_ctx.$props.price)}</span><span style="${ssrRenderStyle({ "font-size": "x-small", "color": "red" })}" data-v-7138e59a${_scopeId2}>-0.89%</span></div>`);
                } else {
                  return [
            ...
            _push2(`</div><div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "column", "justify-content": "start", "align-items": "flex-end" })}" data-v-7138e59a${_scopeId}>`);
            _push2(ssrRenderComponent(_component_ion_card_title, { style: { "margin-bottom": "9px" } }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<strong style="${ssrRenderStyle({ "font-size": "medium" })}" data-v-7138e59a${_scopeId2}>${ssrInterpolate(_ctx.$props.amount)}</strong>`);
                } else {
                  return [
            ...
            _push2(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "justify-content": "center", "align-items": "center" })}" data-v-7138e59a${_scopeId}><span style="${ssrRenderStyle({ "font-size": "small", "margin-right": "5px" })}" data-v-7138e59a${_scopeId}>$ ${ssrInterpolate(_ctx.$props.amount * _ctx.$props.price)}</span></div></div>`);
          } else {
            return [
              createVNode("div", { style: { "display": "flex", "flex-direction": "row", "justify-content": "start", "align-items": "center" } }, [
...
const asset_vue_vue_type_style_index_0_scoped_7138e59a_lang = "";
...
const __nuxt_component_16 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-7138e59a"]]);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_ion_content, { class: "ion-padding" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_ion_card, { style: {} }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img alt="coin"${ssrRenderAttr("src", _imports_0)} style="${ssrRenderStyle({ "scale": "0.9", "margin-top": "-20%", "margin-bottom": "-20%" })}"${_scopeId3}>`);
                        ...
                        return [
                          createVNode("img", {
                            alt: "coin",
                            src: _imports_0,
                            style: { "scale": "0.9", "margin-top": "-20%", "margin-bottom": "-20%" }
                          }),
                  ...
                  return [
                    createVNode(_component_ion_card, { style: {} }, {
                      default: withCtx(() => [
                        createVNode("img", {
                          alt: "coin",
                          src: _imports_0,
                  ...
                  _push3(ssrRenderComponent(_component_ion_card_header, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "justify-content": "space-between", "align-items": "center", "width": "100%" })}" data-v-8c755289${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_ion_card_title, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<strong style="${ssrRenderStyle({ "font-size": "150%" })}" data-v-8c755289${_scopeId4}>${ssrInterpolate(unref(hideTotal) ? "***********" : "$2,260,351.77")}</strong>`);
                            } else {
                              return [
                  ...
                  _push3(ssrRenderComponent(_component_ion_col, { class: "Actions" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<span style="${ssrRenderStyle({ "font-size": "x-small", "color": "white" })}" data-v-8c755289${_scopeId3}>Send</span>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_ion_col, { class: "Actions" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<span style="${ssrRenderStyle({ "font-size": "x-small", "color": "white" })}" data-v-8c755289${_scopeId3}>Recieve</span>`);
                      } else {
                        return [
                          createVNode(_component_ion_button, { size: "large" }, {
                            default: withCtx(() => [
                  ...
                  _push3(ssrRenderComponent(_component_ion_col, { class: "Actions" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<span style="${ssrRenderStyle({ "font-size": "x-small", "color": "white" })}" data-v-8c755289${_scopeId3}>Buy</span>`);
                      } else {
                        return [
                          createVNode(_component_ion_button, { size: "large" }, {
                            default: withCtx(() => [
...
const home_vue_vue_type_style_index_0_scoped_8c755289_lang = "";
...
const home = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8c755289"]]);
export {
  home as default
};
//# sourceMappingURL=home-8dbb0018.js.map
