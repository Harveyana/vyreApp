import { I as IonCard, a as IonItem, b as IonAvatar, d as IonCol, e as IonCardTitle, _ as _export_sfc, f as IonModal, g as IonHeader, h as IonToolbar, i as IonSegment, j as IonSegmentButton, k as IonLabel, l as IonButtons, m as IonButton, n as IonContent, o as IonCardHeader, p as IonCardContent, q as IonList, r as IonTabs, s as IonRouterOutlet, t as IonTabBar, u as IonTabButton, v as IonIcon, w as IonPage, x as IonCardSubtitle, y as IonGrid, z as IonRow } from "../server.mjs";
import { defineComponent, mergeProps, withCtx, createVNode, toDisplayString, useSSRContext, ref, unref, createTextVNode, openBlock, createBlock, Fragment, renderList, watch } from "vue";
import { ssrRenderComponent, ssrRenderAttr, ssrInterpolate, ssrRenderStyle, ssrRenderList } from "vue/server-renderer";
import { p as playCircle, r as radio, l as library, s as search, m as moon, e as eyeOffSharp, a as arrowUpCircleSharp, b as arrowDownCircleSharp, w as walletSharp, c as logoBitcoin, d as logoUsd, f as duplicate } from "./index-2d204393.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_ion_card, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_ion_item, { style: { "display": "flex", "flex-direction": "row", "justify-content": "start", "align-items": "center" } }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_ion_avatar, { slot: "start" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img alt="asset img"${ssrRenderAttr("src", _ctx.$props.img)} data-v-bad56da6${_scopeId3}>`);
                      } else {
                        return [
                          createVNode("img", {
                            alt: "asset img",
                  ...
                  _push3(ssrRenderComponent(_component_ion_col, { style: { "--ion-grid-column-padding-xs": "none" } }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_ion_card_title, { style: { "margin-bottom": "9px" } }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<strong data-v-bad56da6${_scopeId4}>${ssrInterpolate(_ctx.$props.symbol)}</strong>`);
                            } else {
                              return [
                        ...
                        _push4(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "justify-content": "start", "align-items": "center" })}" data-v-bad56da6${_scopeId3}><span style="${ssrRenderStyle({ "font-size": "small", "margin-right": "5px" })}" data-v-bad56da6${_scopeId3}>$${ssrInterpolate(_ctx.$props.price)}</span><span style="${ssrRenderStyle({ "font-size": "x-small", "color": "red" })}" data-v-bad56da6${_scopeId3}>-0.89%</span></div>`);
                      } else {
                        return [
            ...
            _push2(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "column", "justify-content": "start", "align-items": "flex-end" })}" data-v-bad56da6${_scopeId}>`);
            _push2(ssrRenderComponent(_component_ion_card_title, { style: { "margin-bottom": "9px" } }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<strong style="${ssrRenderStyle({ "font-size": "medium" })}" data-v-bad56da6${_scopeId2}>${ssrInterpolate(_ctx.$props.amount)}</strong>`);
                } else {
                  return [
            ...
            _push2(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "justify-content": "center", "align-items": "center" })}" data-v-bad56da6${_scopeId}><span style="${ssrRenderStyle({ "font-size": "small", "margin-right": "5px" })}" data-v-bad56da6${_scopeId}>$ ${ssrInterpolate(_ctx.$props.amount * _ctx.$props.price)}</span></div></div>`);
          } else {
            return [
              createVNode(_component_ion_item, { style: { "display": "flex", "flex-direction": "row", "justify-content": "start", "align-items": "center" } }, {
                default: withCtx(() => [
                  createVNode(_component_ion_avatar, { slot: "start" }, {
                    default: withCtx(() => [
                      createVNode("img", {
...
const asset_vue_vue_type_style_index_0_scoped_bad56da6_lang = "";
...
const __nuxt_component_16 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-bad56da6"]]);
const _imports_0 = "" + __publicAssetsURL("coin_top.svg");
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_ion_card, { style: { "box-shadow": "none" } }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img alt="coin"${ssrRenderAttr("src", _imports_0)} style="${ssrRenderStyle({ "scale": "0.6", "margin-top": "-30%", "margin-bottom": "-30%" })}"${_scopeId3}>`);
                        ...
                        return [
                          createVNode("img", {
                            alt: "coin",
                            src: _imports_0,
                            style: { "scale": "0.6", "margin-top": "-30%", "margin-bottom": "-30%" }
                          }),
...
const tabs_vue_vue_type_style_index_0_scoped_acb77c59_lang = "";
const _sfc_main$1 = {};
                  ...
                  _push3(ssrRenderComponent(_component_ion_card_header, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "justify-content": "space-between", "align-items": "center", "width": "100%" })}" data-v-81497292${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_ion_card_title, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<strong style="${ssrRenderStyle({ "font-size": "150%" })}" data-v-81497292${_scopeId4}>${ssrInterpolate(unref(hideTotal) ? "***********" : "$2,260,351.77")}</strong>`);
                            } else {
                              return [
                  ...
                  _push3(ssrRenderComponent(_component_ion_col, { class: "Actions" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<span style="${ssrRenderStyle({ "font-size": "x-small", "color": "white" })}" data-v-81497292${_scopeId3}>Send</span>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_ion_col, { class: "Actions" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<span style="${ssrRenderStyle({ "font-size": "x-small", "color": "white" })}" data-v-81497292${_scopeId3}>Recieve</span>`);
                      } else {
                        return [
                          createVNode(_component_ion_button, { size: "large" }, {
                            default: withCtx(() => [
                  ...
                  _push3(ssrRenderComponent(_component_ion_col, { class: "Actions" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<span style="${ssrRenderStyle({ "font-size": "x-small", "color": "white" })}" data-v-81497292${_scopeId3}>Buy</span>`);
                      } else {
                        return [
                          createVNode(_component_ion_button, { size: "large" }, {
                            default: withCtx(() => [
...
const home_vue_vue_type_style_index_0_scoped_81497292_lang = "";
...
const home = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-81497292"]]);
export {
  home as default
};
//# sourceMappingURL=home-1eb1a74a.js.map
