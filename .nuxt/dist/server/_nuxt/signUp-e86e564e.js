import { J as useIonRouter, I as IonPage, i as IonContent, d as IonCard, e as IonCardHeader, f as IonCardTitle, H as IonCardContent, x as IonInput, l as IonButton, _ as _export_sfc } from "../server.mjs";
import { defineComponent, ref, withCtx, createTextVNode, createVNode, unref, isRef, useSSRContext } from "vue";
...
import "destr";
import "klona";
const _imports_0 = "" + __publicAssetsURL("rocket.png");
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_ion_card, { style: { "margin": "0px", "min-height": "100%", "background": "#E5E5E5" } }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img alt="Silhouette of mountains"${ssrRenderAttr("src", _imports_0)} style="${ssrRenderStyle({ "height": "190px", "transform": "rotate(90deg)", "background-position": "center", "background-size": "contain", "margin-bottom": "-3%" })}" data-v-190bf3b6${_scopeId3}>`);
                        ...
                        _push4(ssrRenderComponent(_component_ion_card_content, { style: { "position": "relative", "top": "-30%" } }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "align-items": "center", "justify-content": "space-between" })}" data-v-190bf3b6${_scopeId4}>`);
...
const signUp_vue_vue_type_style_index_0_scoped_190bf3b6_lang = "";
...
const signUp = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-190bf3b6"]]);
export {
  signUp as default
};
//# sourceMappingURL=signUp-e86e564e.js.map
