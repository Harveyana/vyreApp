import { d as IonCard, o as IonAvatar, f as IonCardTitle, v as IonCardSubtitle, g as IonIcon, _ as _export_sfc } from "../server.mjs";
import { f as arrowForwardCircle } from "./index-f08fc5f8.js";
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_ion_card, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div style="${ssrRenderStyle({ "max-width": "100%", "height": "100%", "display": "flex", "flex-direction": "row", "justify-content": "center", "align-items": "center", "z-index": "99" })}" data-v-ed66d0cb${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_ion_avatar, {
                    slot: "start",
                    style: { "scale": "1.2", "border": "3px solid #1B1D30" }
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img alt="asset img"${ssrRenderAttr("src", props.img)} data-v-ed66d0cb${_scopeId3}>`);
                      } else {
                        return [
                          createVNode("img", {
                            alt: "asset img",
                  ...
                  _push3(`</div><div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "column", "justify-content": "space-between", "align-items": "flex-start", "max-width": "30%", "height": "100%" })}" data-v-ed66d0cb${_scopeId2}>`);
                  ...
                  _push3(ssrRenderComponent(_component_ion_card_title, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`${ssrInterpolate(props.amount)} <span style="${ssrRenderStyle({ "font-size": "70%" })}" data-v-ed66d0cb${_scopeId3}>${ssrInterpolate(props.symbol)}</span>`);
                      } else {
                        return [
                          createTextVNode(toDisplayString(props.amount) + " ", 1),
                          createVNode("span", { style: { "font-size": "70%" } }, toDisplayString(props.symbol), 1)
                        ];
                      }
                    }),
                    _: 1
                  }, _parent3, _scopeId2));
                  _push3(`</div><div style="${ssrRenderStyle({ "max-width": "100%", "height": "100%", "display": "flex", "flex-direction": "row", "justify-content": "center", "align-items": "center" })}" data-v-ed66d0cb${_scopeId2}>`);
...
const asset_vue_vue_type_style_index_0_scoped_ed66d0cb_lang = "";
...
const __nuxt_component_17 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ed66d0cb"]]);
export {
  __nuxt_component_17 as _
};
//# sourceMappingURL=asset-bc9a5234.js.map
