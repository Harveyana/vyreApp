import { w as IonModal, i as IonContent, g as IonIcon, d as IonCard, f as IonCardTitle, v as IonCardSubtitle, o as IonAvatar, t as IonLabel, x as IonInput, l as IonButton, _ as _export_sfc, j as IonList, y as IonItem, z as IonSelect, A as IonSelectOption } from "../server.mjs";
import { g as closeCircleOutline, h as swapVerticalSharp, i as informationCircle } from "./index-f08fc5f8.js";
import { defineComponent, mergeProps, withCtx, unref, createTextVNode, createVNode, useSSRContext, ref, toDisplayString, openBlock, createBlock, Fragment, renderList, createCommentVNode } from "vue";
...
const _imports_1 = "" + __publicAssetsURL("nigeria.svg");
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_ion_content, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div style="${ssrRenderStyle({ "height": "8%", "width": "100%", "display": "flex", "flex-direction": "row", "align-items": "flex-end", "justify-content": "end", "margin-bottom": "2%" })}" data-v-20cb49c0${_scopeId2}>`);
                  ...
                  _push3(`</div><div style="${ssrRenderStyle({ "margin": "0px", "display": "flex", "flex-direction": "row", "align-items": "center", "justify-content": "space-around", "background": "none" })}" data-v-20cb49c0${_scopeId2}>`);
                  ...
                  _push3(`<div style="${ssrRenderStyle({ "max-width": "100%", "height": "100%", "display": "flex", "flex-direction": "row", "justify-content": "center", "align-items": "center" })}" data-v-20cb49c0${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_ion_avatar, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img alt="asset img"${ssrRenderAttr("src", _imports_0)} data-v-20cb49c0${_scopeId3}>`);
                      } else {
                        return [
                          createVNode("img", {
                            alt: "asset img",
                  ...
                  _push3(ssrRenderComponent(_component_ion_avatar, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img alt="asset img"${ssrRenderAttr("src", _imports_1)} data-v-20cb49c0${_scopeId3}>`);
                      } else {
                        return [
                          createVNode("img", {
                            alt: "asset img",
                  ...
                  _push3(`</div></div>`);
                  _push3(ssrRenderComponent(_component_ion_card, { style: { "margin": "0px", "display": "flex", "flex-direction": "column", "align-items": "center", "justify-content": "center", "height": "30%", "margin-top": "7%", "background": "#1d3160", "box-shadow": "none", "padding-top": "3%", "padding-bottom": "3%" } }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "align-items": "center", "justify-content": "space-around", "height": "30%", "width": "90%", "border": "1px solid white", "border-radius": "25px", "padding": "4%", "background": "#1d3160" })}" data-v-20cb49c0${_scopeId3}>`);
                        ...
                        _push4(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "align-items": "center", "justify-content": "space-around", "height": "30%", "width": "90%", "border": "1px solid goldenrod", "border-radius": "25px", "padding": "4%", "background": "goldenrod" })}" data-v-20cb49c0${_scopeId3}>`);
                        ...
                        return [
                          createVNode("div", { style: { "display": "flex", "flex-direction": "row", "align-items": "center", "justify-content": "space-around", "height": "30%", "width": "90%", "border": "1px solid white", "border-radius": "25px", "padding": "4%", "background": "#1d3160" } }, [
                          ...
                          createVNode("div", { style: { "display": "flex", "flex-direction": "row", "align-items": "center", "justify-content": "space-around", "height": "30%", "width": "90%", "border": "1px solid goldenrod", "border-radius": "25px", "padding": "4%", "background": "goldenrod" } }, [
                  ...
                  _push3(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "align-items": "center", "justify-content": "center", "margin-top": "8%" })}" data-v-20cb49c0${_scopeId2}>`);
                  ...
                  return [
                    createVNode("div", { style: { "height": "8%", "width": "100%", "display": "flex", "flex-direction": "row", "align-items": "flex-end", "justify-content": "end", "margin-bottom": "2%" } }, [
                      createVNode(_component_ion_icon, {
                        icon: "ioniconsCloseCircleOutline" in _ctx ? _ctx.ioniconsCloseCircleOutline : unref(closeCircleOutline),
                        style: { "font-size": "300%", "margin-right": "4%" },
                        onClick: ($event) => _ctx.$emit("closeModal")
                    ...
                    createVNode(_component_ion_card, { style: { "margin": "0px", "display": "flex", "flex-direction": "column", "align-items": "center", "justify-content": "center", "height": "30%", "margin-top": "7%", "background": "#1d3160", "box-shadow": "none", "padding-top": "3%", "padding-bottom": "3%" } }, {
                      default: withCtx(() => [
                        createVNode("div", { style: { "display": "flex", "flex-direction": "row", "align-items": "center", "justify-content": "space-around", "height": "30%", "width": "90%", "border": "1px solid white", "border-radius": "25px", "padding": "4%", "background": "#1d3160" } }, [
                          createVNode(_component_ion_label, { style: { "font-size": "150%", "color": "whitesmoke" } }, {
                            default: withCtx(() => [
...
const orderDetails_vue_vue_type_style_index_0_scoped_20cb49c0_lang = "";
...
const __nuxt_component_15 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-20cb49c0"]]);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_ion_content, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div style="${ssrRenderStyle({ "height": "8%", "width": "100%", "display": "flex", "flex-direction": "row", "align-items": "start", "justify-content": "start", "margin-top": "7%", "padding": "0 5% 0 5%" })}" data-v-93a8ddca${_scopeId2}>`);
                  ...
                  _push3(`</div><div style="${ssrRenderStyle({ "height": "8%", "width": "100%", "display": "flex", "flex-direction": "row", "align-items": "start", "justify-content": "start", "padding": "0 5% 0 5%" })}" data-v-93a8ddca${_scopeId2}>`);
                  ...
                  _push3(`</div><div style="${ssrRenderStyle({ "margin": "0px", "display": "flex", "flex-direction": "row", "align-items": "center", "justify-content": "space-around", "background": "none" })}" data-v-93a8ddca${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_ion_card, { style: { "box-shadow": "none", "background": "none", "z-index": "888", "margin": "0px", "width": "40%", "position": "relative", "bottom": "8%" } }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_ion_card_title, {
                  ...
                  _push3(`<div style="${ssrRenderStyle({ "max-width": "100%", "height": "100%", "display": "flex", "flex-direction": "row", "justify-content": "center", "align-items": "center" })}" data-v-93a8ddca${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_ion_avatar, {
                    slot: "start",
                    style: { "scale": "1.3", "border": "3px solid #1B1D30" }
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        if (unref(baseImgUrl)) {
                          _push4(`<img alt="asset img"${ssrRenderAttr("src", unref(baseImgUrl))} data-v-93a8ddca${_scopeId3}>`);
                        } else {
                          _push4(`<!---->`);
                        }
                      } else {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        if (unref(quoteImgUrl)) {
                          _push4(`<img alt="asset img"${ssrRenderAttr("src", unref(quoteImgUrl))} data-v-93a8ddca${_scopeId3}>`);
                        } else {
                          _push4(`<!---->`);
                        }
                      } else {
                  ...
                  _push3(`</div></div><div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "align-items": "center", "justify-content": "space-around", "height": "9%", "width": "100%", "border": "1px solid white", "border-radius": "25px", "padding": "4%", "margin-top": "7%" })}" data-v-93a8ddca${_scopeId2}>`);
                  ...
                  _push3(`</div>`);
                  _push3(ssrRenderComponent(_component_ion_card, { style: { "margin": "0px", "display": "flex", "flex-direction": "column", "align-items": "center", "justify-content": "center", "height": "30%", "margin-top": "2%", "background": "#1d3160", "box-shadow": "none", "padding-top": "3%", "padding-bottom": "3%" } }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "align-items": "center", "justify-content": "space-around", "height": "30%", "width": "90%", "border": "1px solid white", "border-radius": "25px", "padding": "4%", "background": "#1d3160" })}" data-v-93a8ddca${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_ion_label, { style: { "font-size": "150%", "color": "whitesmoke" } }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`You Send`);
                        ...
                        _push4(`</div><div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "align-items": "center", "justify-content": "center", "width": "90%" })}" data-v-93a8ddca${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_ion_icon, {
                          color: "secondary",
                          icon: "ioniconsSwapVerticalSharp" in _ctx ? _ctx.ioniconsSwapVerticalSharp : unref(swapVerticalSharp),
                        ...
                        _push4(`</div><div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "align-items": "center", "justify-content": "space-around", "height": "30%", "width": "90%", "border": "1px solid goldenrod", "border-radius": "25px", "padding": "4%", "background": "goldenrod" })}" data-v-93a8ddca${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_ion_label, { style: { "font-size": "150%", "color": "black" } }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`You Get`);
                  ...
                  _push3(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "align-items": "center", "justify-content": "center", "margin-top": "8%" })}" data-v-93a8ddca${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_ion_button, {
                    fill: "outline",
                    style: { "width": "80%", "height": "50px", "font-size": "130%" },
                    onClick: ($event) => _ctx.$emit("closeModal")
                  ...
                  return [
                    createVNode("div", { style: { "height": "8%", "width": "100%", "display": "flex", "flex-direction": "row", "align-items": "start", "justify-content": "start", "margin-top": "7%", "padding": "0 5% 0 5%" } }, [
                    ...
                    createVNode("div", { style: { "height": "8%", "width": "100%", "display": "flex", "flex-direction": "row", "align-items": "start", "justify-content": "start", "padding": "0 5% 0 5%" } }, [
                    ...
                    createVNode("div", { style: { "display": "flex", "flex-direction": "row", "align-items": "center", "justify-content": "space-around", "height": "9%", "width": "100%", "border": "1px solid white", "border-radius": "25px", "padding": "4%", "margin-top": "7%" } }, [
                      createVNode(_component_ion_label, { style: { "font-size": "120%", "color": "black" } }, {
                        default: withCtx(() => [
                          createTextVNode("Quote Price")
                        ]),
                    ...
                    createVNode(_component_ion_card, { style: { "margin": "0px", "display": "flex", "flex-direction": "column", "align-items": "center", "justify-content": "center", "height": "30%", "margin-top": "2%", "background": "#1d3160", "box-shadow": "none", "padding-top": "3%", "padding-bottom": "3%" } }, {
                      default: withCtx(() => [
                        createVNode("div", { style: { "display": "flex", "flex-direction": "row", "align-items": "center", "justify-content": "space-around", "height": "30%", "width": "90%", "border": "1px solid white", "border-radius": "25px", "padding": "4%", "background": "#1d3160" } }, [
                          createVNode(_component_ion_label, { style: { "font-size": "150%", "color": "whitesmoke" } }, {
                            default: withCtx(() => [
...
const newOrder_vue_vue_type_style_index_0_scoped_93a8ddca_lang = "";
...
const __nuxt_component_16 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-93a8ddca"]]);
export {
  __nuxt_component_15 as _,
  __nuxt_component_16 as a
};
//# sourceMappingURL=newOrder-0a8bd02e.js.map
