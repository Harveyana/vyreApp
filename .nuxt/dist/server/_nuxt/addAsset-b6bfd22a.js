import { E as IonItem, y as IonAvatar, p as IonCol, o as IonCardTitle, _ as _export_sfc, f as IonIcon, v as IonModal, i as IonHeader, I as IonToolbar, s as IonSegment, t as IonSegmentButton, g as IonLabel, j as IonButtons, k as IonButton, D as IonContent, l as IonCard, m as IonCardHeader, A as IonCardContent, u as IonList } from "../server.mjs";
...
import { k as addCircle, j as returnUpBack } from "./index-5cbc2a09.js";
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_ion_avatar, { slot: "start" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<img alt="asset img"${ssrRenderAttr("src", _ctx.$props.img)} data-v-031e014e${_scopeId2}>`);
                } else {
                  return [
                    createVNode("img", {
                      alt: "asset img",
            ...
            _push2(ssrRenderComponent(_component_ion_col, { style: { "--ion-grid-column-padding-xs": "none" } }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "justify-content": "start", "align-items": "center" })}" data-v-031e014e${_scopeId2}><span style="${ssrRenderStyle({ "font-size": "small", "margin-right": "5px" })}" data-v-031e014e${_scopeId2}>$${ssrInterpolate(_ctx.$props.price)}</span><span style="${ssrRenderStyle({ "font-size": "x-small", "color": "red" })}" data-v-031e014e${_scopeId2}>-0.89%</span></div>`);
                } else {
                  return [
            ...
            _push2(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "column", "justify-content": "start", "align-items": "flex-end" })}" data-v-031e014e${_scopeId}>`);
            ...
            _push2(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "justify-content": "center", "align-items": "center" })}" data-v-031e014e${_scopeId}><span style="${ssrRenderStyle({ "font-size": "small", "margin-right": "5px" })}" data-v-031e014e${_scopeId}>$ ${ssrInterpolate(_ctx.$props.amount * _ctx.$props.price)}</span></div></div>`);
          } else {
            return [
...
const asset_vue_vue_type_style_index_0_scoped_031e014e_lang = "";
...
const __nuxt_component_17 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-031e014e"]]);
...
//# sourceMappingURL=addAsset-b6bfd22a.js.map
