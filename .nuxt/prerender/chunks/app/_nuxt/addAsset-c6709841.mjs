import { _ as _export_sfc, E as IonItem, v as IonAvatar, p as IonCol, o as IonCardTitle, f as IonIcon, w as IonModal, i as IonHeader, I as IonToolbar, s as IonSegment, t as IonSegmentButton, g as IonLabel, j as IonButtons, k as IonButton, z as IonContent, l as IonCard, m as IonCardHeader, y as IonCardContent, u as IonList } from '../server.mjs';
import { useSSRContext, defineComponent, mergeProps, withCtx, createVNode, createTextVNode, toDisplayString, unref, ref, openBlock, createBlock, Fragment, renderList } from 'file:///Users/mac/vyreApp/node_modules/vue/index.mjs';
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_ion_item, mergeProps({
        ...
        detail: false,
        lines: "none",
        style: { "--border-radius": "13px", "margin-bottom": "3%" }
      }, _attrs), {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_ion_avatar, { slot: "start" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<img alt="asset img"${ssrRenderAttr("src", _ctx.$props.img)} data-v-c18bffb0${_scopeId2}>`);
                } else {
                  return [
                    createVNode("img", {
                      alt: "asset img",
            ...
            _push2(ssrRenderComponent(_component_ion_col, { style: { "--ion-grid-column-padding-xs": "none", "background": "none" } }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "justify-content": "start", "align-items": "center" })}" data-v-c18bffb0${_scopeId2}><span style="${ssrRenderStyle({ "font-size": "small", "margin-right": "5px" })}" data-v-c18bffb0${_scopeId2}>$${ssrInterpolate(_ctx.$props.price)}</span><span style="${ssrRenderStyle({ "font-size": "x-small", "color": "red" })}" data-v-c18bffb0${_scopeId2}>-0.89%</span></div>`);
                } else {
                  return [
            ...
            _push2(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "column", "justify-content": "start", "align-items": "flex-end" })}" data-v-c18bffb0${_scopeId}>`);
            _push2(ssrRenderComponent(_component_ion_card_title, { style: { "margin-bottom": "9px", "font-size": "80%" } }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(_ctx.$props.amount)}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(_ctx.$props.amount), 1)
                  ];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            _push2(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "justify-content": "center", "align-items": "center" })}" data-v-c18bffb0${_scopeId}><span style="${ssrRenderStyle({ "font-size": "small", "margin-right": "5px" })}" data-v-c18bffb0${_scopeId}>$ ${ssrInterpolate(_ctx.$props.amount * _ctx.$props.price)}</span></div></div>`);
          } else {
            return [
              ...
              createVNode(_component_ion_col, { style: { "--ion-grid-column-padding-xs": "none", "background": "none" } }, {
                default: withCtx(() => [
                  createVNode(_component_ion_card_title, { style: { "margin-bottom": "9px", "font-size": "80%" } }, {
                    default: withCtx(() => [
                      createTextVNode(toDisplayString(_ctx.$props.symbol), 1)
...
const __nuxt_component_17 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-c18bffb0"]]);
...
const arrowForwardCircleSharp = "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' class='ionicon' viewBox='0 0 512 512'><path d='M464 256c0-114.87-93.13-208-208-208S48 141.13 48 256s93.13 208 208 208 208-93.13 208-208zm-224 80.09L303.58 272H154v-32h149.58L240 175.91l22.71-22.54L364.54 256 262.7 358.63z'/></svg>";
...
const playCircle = "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' class='ionicon' viewBox='0 0 512 512'><path d='M256 48C141.31 48 48 141.31 48 256s93.31 208 208 208 208-93.31 208-208S370.69 48 256 48zm74.77 217.3l-114.45 69.14a10.78 10.78 0 01-16.32-9.31V186.87a10.78 10.78 0 0116.32-9.31l114.45 69.14a10.89 10.89 0 010 18.6z'/></svg>";
...
export { __nuxt_component_17 as _, arrowUpCircleSharp as a, arrowDownCircleSharp as b, logoUsd as c, duplicate as d, eyeOffSharp as e, _sfc_main as f, library as g, home as h, arrowForwardCircleSharp as i, returnUpBack as j, peopleCircleOutline as k, logoBitcoin as l, moon as m, notifications as n, open as o, playCircle as p, settings as q, radio as r, search as s, thumbsUp as t, walletSharp as w };
//# sourceMappingURL=addAsset-c6709841.mjs.map
