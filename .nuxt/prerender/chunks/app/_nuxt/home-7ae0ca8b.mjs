...
import { _ as _export_sfc, l as IonCard, o as IonCardTitle, n as IonCardSubtitle, v as IonAvatar, w as IonModal, h as IonPage, i as IonHeader, I as IonToolbar, k as IonButton, f as IonIcon, j as IonButtons, m as IonCardHeader, g as IonLabel, x as IonFooter, s as IonSegment, t as IonSegmentButton, u as IonList, y as IonCardContent, z as IonContent, A as IonChip } from '../server.mjs';
import { h as home$1, m as moon, e as eyeOffSharp, a as arrowUpCircleSharp, b as arrowDownCircleSharp, i as arrowForwardCircleSharp, j as returnUpBack, k as peopleCircleOutline, t as thumbsUp, n as notifications, d as duplicate, o as open, f as _sfc_main$7, _ as __nuxt_component_17$2 } from './addAsset-91afadc7.mjs';
import { _ as __nuxt_component_19$1 } from './allAssets-b4dac11b.mjs';
import { useSSRContext, defineComponent, mergeProps, withCtx, createTextVNode, toDisplayString, createVNode, ref, watch, unref, openBlock, createBlock, Fragment, renderList, createCommentVNode } from 'file:///Users/mac/vyreApp/node_modules/vue/index.mjs';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_ion_card, {
              class: "subAsset",
              style: { "display": "flex", "flex-direction": "row", "justify-content": "space-between", "align-items": "center", "width": "100%", "border-radius": "12px", "padding-left": "5%", "padding-right": "5%", "box-shadow": "none", "margin": "3%" }
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "column", "justify-content": "space-between", "align-items": "flex-start", "max-width": "30%", "height": "100%" })}" data-v-7e204a62${_scopeId2}>`);
                  ...
                  _push3(`</div><div style="${ssrRenderStyle({ "max-width": "100%", "height": "100%", "display": "flex", "flex-direction": "row", "justify-content": "center", "align-items": "center" })}" data-v-7e204a62${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_ion_avatar, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img alt="asset img"${ssrRenderAttr("src", props.baseImgUrl)} data-v-7e204a62${_scopeId3}>`);
                      } else {
                        return [
                          createVNode("img", {
                            alt: "asset img",
                  ...
                  _push3(ssrRenderComponent(_component_ion_avatar, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img alt="asset img"${ssrRenderAttr("src", props.quoteImgUrl)} data-v-7e204a62${_scopeId3}>`);
                      } else {
                        return [
                          createVNode("img", {
                            alt: "asset img",
...
const __nuxt_component_17$1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-7e204a62"]]);
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_AddAsset = _sfc_main$7;
      ...
      const _component_order = __nuxt_component_17$1;
      const _component_asset = __nuxt_component_17$2;
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(_component_ion_icon, {
                                      slot: "end",
                                      icon: "ioniconsHome" in _ctx ? _ctx.ioniconsHome : unref(home$1)
                                    ...
                                    _push6(ssrRenderComponent(_component_ion_card_header, { style: {} }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          ...
                                          _push7(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "justify-content": "space-between", "align-items": "center", "width": "100%" })}" data-v-97ff177c${_scopeId6}>`);
                                          _push7(ssrRenderComponent(_component_ion_card_title, { color: "primary" }, {
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(`<strong style="${ssrRenderStyle({ "font-size": "80%" })}" data-v-97ff177c${_scopeId7}>${ssrInterpolate(unref(hideTotal) ? "***********" : "$2,260,351.77")}</strong>`);
                                              } else {
                                                return [
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(ssrRenderComponent(_component_ion_card_header, { style: {} }, {
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "justify-content": "space-between", "align-items": "center", "width": "100%" })}" data-v-97ff177c${_scopeId7}>`);
                                                _push8(ssrRenderComponent(_component_ion_card_title, { color: "primary" }, {
                                                  default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                    if (_push9) {
                                                      _push9(`<strong style="${ssrRenderStyle({ "font-size": "50%" })}" data-v-97ff177c${_scopeId8}>${ssrInterpolate(unref(hideTotal) ? "***********" : "$2,260")}</strong>`);
                                                    } else {
                                                      return [
                                            ...
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                ...
                                                _push8(ssrRenderComponent(_component_ion_card_title, { color: "primary" }, {
                                                  default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                    if (_push9) {
                                                      _push9(`<strong style="${ssrRenderStyle({ "font-size": "50%" })}" data-v-97ff177c${_scopeId8}>${ssrInterpolate(unref(hideTotal) ? "***********" : "$1,260,351")}</strong>`);
                                                    } else {
                                                      return [
                  ...
                  _push3(ssrRenderComponent(_component_ion_footer, {
                    class: "ion-no-border",
                    style: { "min-height": "45%", "border-top-left-radius": "38px", "border": "1px solid black" }
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
...
const __nuxt_component_18 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-97ff177c"]]);
...
const __nuxt_component_13 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-40a8e53d"]]);
...
const __nuxt_component_6 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-d6ef4f6e"]]);
...
const __nuxt_component_17 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-2271b289"]]);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_SendAssetChoice = __nuxt_component_17;
      _push(ssrRenderComponent(_component_ion_modal, mergeProps({
...
const __nuxt_component_19 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-521627d2"]]);
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(_component_ion_avatar, null, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<img alt="Silhouette of a person&#39;s head" src="https://ionicframework.com/docs/img/demos/avatar.svg" data-v-f6fa7624${_scopeId6}>`);
                                        } else {
                                          return [
                                            createVNode("img", {
                                          ...
                                          _push7(ssrRenderComponent(_component_ion_card_header, null, {
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                ...
                                                _push8(`<div class="figureCard" style="${ssrRenderStyle({})}" data-v-f6fa7624${_scopeId7}>`);
                                                _push8(ssrRenderComponent(_component_ion_card_title, { color: "primary" }, {
                                                  default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                    if (_push9) {
                                                      _push9(`<strong style="${ssrRenderStyle({ "font-size": "80%" })}" data-v-f6fa7624${_scopeId8}>${ssrInterpolate(unref(hideTotal) ? "***********" : "$2,260,351.77")}</strong>`);
                                                    } else {
                                                      return [
                                                        createVNode("strong", { style: { "font-size": "80%" } }, toDisplayString(unref(hideTotal) ? "***********" : "$2,260,351.77"), 1)
                                                      ];
...
const home = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f6fa7624"]]);

export { home as default };
//# sourceMappingURL=home-7ae0ca8b.mjs.map
