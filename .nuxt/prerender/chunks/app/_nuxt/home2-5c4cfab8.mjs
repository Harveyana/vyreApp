import { _ as _export_sfc, I as IonPage, a as IonHeader, b as IonToolbar, d as IonCard, e as IonCardHeader, w as IonLabel, f as IonCardTitle, g as IonIcon, i as IonContent, l as IonButton, n as IonChip, o as IonAvatar, k as IonFooter } from '../server.mjs';
import { _ as __nuxt_component_3, a as __nuxt_component_14 } from './tabs-3467ae62.mjs';
import { _ as _sfc_main$1 } from './addAsset-94752b17.mjs';
import { _ as __nuxt_component_19 } from './allAssets-c17702d6.mjs';
import { _ as __nuxt_component_17 } from './assetpage-4ecffefd.mjs';
import { useSSRContext, defineComponent, ref, mergeProps, withCtx, createTextVNode, unref, createVNode, toDisplayString, openBlock, createBlock, Fragment, renderList } from 'file:///Users/mac/vyreApp/node_modules/vue/index.mjs';
import { e as eyeOffSharp, h as chevronUpOutline, w as walletSharp } from './index-f08fc5f8.mjs';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_ion_header, {
              class: "ion-no-border",
              style: { "max-height": "33%", "min-height": "30%" }
            }, {
                  ...
                  _push3(ssrRenderComponent(_component_ion_toolbar, { style: { "min-height": "100%", "max-height": "100%" } }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                              ...
                              _push5(ssrRenderComponent(_component_ion_card_header, null, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    ...
                                    _push6(`<div class="figureCard" style="${ssrRenderStyle({})}" data-v-3a0601d9${_scopeId5}>`);
                                    _push6(ssrRenderComponent(_component_ion_card_title, { color: "primary" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<strong style="${ssrRenderStyle({ "font-size": "90%" })}" data-v-3a0601d9${_scopeId6}>${ssrInterpolate(unref(hideTotal) ? "***********" : "$2,260,351.77")}</strong>`);
                                        } else {
                                          return [
                        ...
                        _push4(ssrRenderComponent(_component_ion_card, { style: { "display": "flex", "flex-direction": "row", "align-items": "center", "justify-content": "space-around", "width": "100%", "height": "5%", "margin": "0px", "background": "none", "box-shadow": "none", "z-index": "999" } }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(_component_ion_card_header, null, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<div class="figureCard" style="${ssrRenderStyle({})}" data-v-3a0601d9${_scopeId6}>`);
                        ...
                        return [
                          ...
                          createVNode(_component_ion_card, { style: { "display": "flex", "flex-direction": "row", "align-items": "center", "justify-content": "space-around", "width": "100%", "height": "5%", "margin": "0px", "background": "none", "box-shadow": "none", "z-index": "999" } }, {
                            default: withCtx(() => [
                              createVNode(_component_ion_card, {
                                class: "footerActions",
                                button: true,
            ...
            _push2(ssrRenderComponent(_component_ion_content, { style: {} }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "align-items": "center", "justify-content": "center", "border": "1px solid black" })}" data-v-3a0601d9${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_ion_card, { style: { "height": "80%", "width": "70%", "margin": "0px", "display": "flex", "flex-direction": "row", "align-items": "center", "justify-content": "center" } }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img alt="advert"${ssrRenderAttr("src", _imports_0)} style="${ssrRenderStyle({ "width": "70%", "height": "100%" })}" data-v-3a0601d9${_scopeId3}>`);
                      } else {
                        return [
                          createVNode("img", {
                            alt: "advert",
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_ion_card_header, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "row", "align-items": "center", "justify-content": "space-between" })}" data-v-3a0601d9${_scopeId4}>`);
                      ...
                      if (_push4) {
                        ...
                        ssrRenderList(actions, (action) => {
                          _push4(ssrRenderComponent(_component_ion_chip, {
                            ...
                            id: action.id,
                            key: "action.name",
                            style: { "box-shadow": "10px whitesmoke", "border-radius": "12px", "padding": "8%", "background": "white" }
                          }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(ssrRenderComponent(_component_ion_avatar, { style: { "--border-radius": "8px", "min-width": "10%" } }, {
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<img alt="coin"${ssrRenderAttr("src", action.img)} style="${ssrRenderStyle({ "scale": "1.4" })}" data-v-3a0601d9${_scopeId5}>`);
                                    } else {
                                      return [
                                        createVNode("img", {
                                          alt: "coin",
                                ...
                                _push5(`<div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "column", "align-items": "start", "flex-wrap": "nowrap", "justify-content": "center", "width": "100%", "position": "relative", "left": "2%" })}" data-v-3a0601d9${_scopeId4}>`);
                                _push5(ssrRenderComponent(_component_ion_label, {
                                  color: "primary",
                                ...
                                _push5(`</div><div style="${ssrRenderStyle({ "display": "flex", "flex-direction": "column", "align-items": "end", "flex-wrap": "no-wrap", "justify-content": "center", "margin-left": "5%", "width": "30%" })}" data-v-3a0601d9${_scopeId4}>`);
                                _push5(ssrRenderComponent(_component_ion_label, {
                                  color: "primary",
                                  style: { "font-size": "90%", "margin-bottom": "7px", "font-weight": "bold" }
                                }, {
                  ...
                  return [
                    createVNode("div", { style: { "display": "flex", "flex-direction": "row", "align-items": "center", "justify-content": "center", "border": "1px solid black" } }, [
                      createVNode(_component_ion_card, { style: { "height": "80%", "width": "70%", "margin": "0px", "display": "flex", "flex-direction": "row", "align-items": "center", "justify-content": "center" } }, {
                        default: withCtx(() => [
                          createVNode("img", {
                            alt: "advert",
                            src: _imports_0,
...
const home2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3a0601d9"]]);

export { home2 as default };
//# sourceMappingURL=home2-5c4cfab8.mjs.map
