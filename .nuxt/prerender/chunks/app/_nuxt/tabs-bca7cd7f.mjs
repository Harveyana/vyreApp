...
import { _ as _export_sfc, u as useIonRouter, p as useRoute, b as IonCard, o as IonButton, g as IonIcon, w as IonBadge, f as IonChip, m as IonAvatar, s as IonToolbar, x as IonTabs, y as IonRouterOutlet, z as IonTabBar, A as IonTabButton } from '../server.mjs';
import { useSSRContext, defineComponent, ref, watch, mergeProps, withCtx, unref, createVNode, createTextVNode, openBlock, createBlock, computed } from 'file:///Users/mac/vyreApp/node_modules/vue/index.mjs';
import { u as useDarkMode } from './useDarkMode-386da5e9.mjs';
import { z as returnUpBack, g as moon, C as notificationsCircle, D as prismSharp, E as cubeSharp, F as diamondSharp, G as settingsOutline } from './index-d43f4fcb.mjs';
import { ssrRenderComponent, ssrRenderStyle, ssrRenderAttr } from 'file:///Users/mac/vyreApp/node_modules/vue/server-renderer/index.mjs';

const _imports_0 = "" + publicAssetsURL("harveyana.png");
          ...
          if (_push2) {
            if (props.showBackButton) {
              _push2(ssrRenderComponent(_component_ion_button, {
                fill: "clear",
                style: { "border-radius": "10px", "height": "30px", "background": "none" },
                onClick: ($event) => unref(ionRouter).back()
              }, {
            ...
            _push2(`<div style="${ssrRenderStyle({ "display": "flex", "justify-content": "center", "align-items": "center", "width": "50%" })}" data-v-94978da5${_scopeId}>`);
            _push2(ssrRenderComponent(_component_ion_button, {
              fill: "clear",
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_ion_avatar, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<img alt="profilePic"${ssrRenderAttr("src", _imports_0)} style="${ssrRenderStyle({ "scale": "1.6" })}" data-v-94978da5${_scopeId3}>`);
                      } else {
                        return [
                          createVNode("img", {
                            alt: "profilePic",
            ...
            return [
              props.showBackButton ? (openBlock(), createBlock(_component_ion_button, {
                key: 0,
                fill: "clear",
                style: { "border-radius": "10px", "height": "30px", "background": "none" },
                onClick: ($event) => unref(ionRouter).back()
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-94978da5"]]);
...
export { __nuxt_component_3 as _, __nuxt_component_14 as a };
//# sourceMappingURL=tabs-bca7cd7f.mjs.map
