...
const styles = {
  ...
  "pages/homelast.vue": () => import('./_nuxt/homelast-styles.95959e12.mjs').then(interopDefault),
  ...
  "pages/p2p.vue": () => import('./_nuxt/p2p-styles.da1cff61.mjs').then(interopDefault),
