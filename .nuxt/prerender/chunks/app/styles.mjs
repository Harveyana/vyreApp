...
const styles = {
  ...
  "pages/homelast.vue": () => import('./_nuxt/homelast-styles.7d115766.mjs').then(interopDefault),
  ...
  "pages/p2p.vue": () => import('./_nuxt/p2p-styles.169877b5.mjs').then(interopDefault),
